...
private:	
	...
	uint32_t destHeight;
	bool resizing = false;
	VkAPI::UIOverlay *UIOverlay = nullptr;
...
public: 
	...
	HWND window;              // win´°Ìå
	HINSTANCE windowInstance; // win´°ÌåÊµÀý
	...
	*/
	...
	virtual void OnSetupUIOverlay(VkAPI::UIOverlayCreateInfo &createInfo);
	/** @brief (Virtual) Called when the UI overlay is updating, can be used to add custom elements to the overlay */
	virtual void OnUpdateUIOverlay(VkAPI::UIOverlay *overlay);
};
