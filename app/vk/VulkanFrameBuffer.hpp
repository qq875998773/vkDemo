...
namespace VkAPI
{
	...
	*/
	...
	{
	private:
		VkAPI::VulkanDevice *vulkanDevice;
	public:
		uint32_t width, height;
		VkFramebuffer framebuffer;
		VkRenderPass renderPass;
		VkSampler sampler;
		std::vector<VkAPI::FramebufferAttachment> attachments;
		...
		*/
		Framebuffer(VkAPI::VulkanDevice *vulkanDevice)
		{
			assert(vulkanDevice);
		...
		*/
		uint32_t addAttachment(VkAPI::AttachmentCreateInfo createinfo)
		{
			VkAPI::FramebufferAttachment attachment;
			...
			VkImageCreateInfo image = VkAPI::initializers::imageCreateInfo();
			...
			VkImageViewCreateInfo imageView = VkAPI::initializers::imageViewCreateInfo();
