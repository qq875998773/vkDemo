...
namespace VkAPI
{
	...
	public:
		...
		*/
		...
		{
			if (!VkAPI::tools::fileExists(filename)) {
				VkAPI::tools::exitFatal("Could not load texture from " + filename + "\n\nThe file may be part of the additional asset pack.\n\nRun \"download_assets.py\" in the repository root to download the latest version.", -1);
			}
			...
			if (useStaging)
			{
				...
				VkBufferCreateInfo bufferCreateInfo = VkAPI::initializers::bufferCreateInfo();
				...
				VkImageCreateInfo imageCreateInfo = VkAPI::initializers::imageCreateInfo();
			...
			else
			{
				...
				VkAPI::tools::setImageLayout(copyCmd, image, VK_IMAGE_ASPECT_COLOR_BIT, VK_IMAGE_LAYOUT_UNDEFINED, imageLayout);
	...
	public:
		...
		*/
			...
			VkImageLayout imageLayout = VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL)
		{
			...
			// Create sampler
			VkSamplerCreateInfo samplerCreateInfo = VkAPI::initializers::samplerCreateInfo();
			samplerCreateInfo.magFilter = VK_FILTER_LINEAR;
			samplerCreateInfo.minFilter = VK_FILTER_LINEAR;
			samplerCreateInfo.mipmapMode = VK_SAMPLER_MIPMAP_MODE_LINEAR;
			...
			// Create image view
			VkImageViewCreateInfo viewCreateInfo = VkAPI::initializers::imageViewCreateInfo();
