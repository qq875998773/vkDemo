...
public:
    ...
    // 初始化交换链
    void initSurface(void* platformHandle, void* platformWindow)  // cc修改
    {
        ...
        if (err != VK_SUCCESS) {
            VkAPI::tools::exitFatal("Could not create surface!", err);
        }
        ...
        {
            VkAPI::tools::exitFatal("Could not find a graphics and/or presenting queue!", -1);
        }

        // todo : Add support for separate graphics and presenting queue
        if (graphicsQueueNodeIndex != presentQueueNodeIndex)
        {
            VkAPI::tools::exitFatal("Separate graphics and presenting queues are not supported yet!", -1);
        }
